...
--     {"pnb_02.dds", 0, "pnb_02", false};
   ...
   --[[
    ...
    --{"light-yellow", 0, "bano-yellow", true};
     ...
     {"pnb_mirror", 0, "mirrors", true}; -- dynamic mirror replacement texture
     {"pnb_mirror_l", 0, "mirrors", true}; -- dynamic mirror replacement texture
     {"pnb_mirror_r", 0, "mirrors", true}; -- dynamic mirror replacement texture
}
