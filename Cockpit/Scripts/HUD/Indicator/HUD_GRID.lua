...
local HUD_BoresightRoot = addStrokeSymbol("HUD_Boresight_Cross", {"pnb_stroke_symbols_HUD", "1-boresight-cross"}, "CenterCenter", {0, DegToMil(1.2)})

-- FYT
object = addStrokeSymbol(nil, {"pnb_stroke_symbols_HUD", "aim9lm-caged"}, "CenterCenter", {0, 0})
...
object = addStrokeSymbol(nil, {"pnb_stroke_symbols_HUD", "fpm-cross"}, "CenterCenter", {0, 0}, object.name)
...
-- OAP
object = addStrokeSymbol(nil, {"pnb_stroke_symbols_HUD", "8-oap"}, "CenterCenter", {0, 0})
...
object = addStrokeSymbol(nil, {"pnb_stroke_symbols_HUD", "5-target"}, "CenterCenter", {0, 0}, HUD_CCRP_origin.name)
...
-- CCIP Bomb cue
object = addStrokeSymbol(nil, {"pnb_stroke_symbols_HUD", "4-impact-point"}, "CenterCenter", {0, 0}, HUD_CCIP_BOMB_origin.name)
object.element_params = {"HUD_BRIGHT", "HUD_CCIP_PIPER_AZIMUTH", "HUD_CCIP_PIPER_ELEVATION"}
object.controllers = {
	{"opacity_using_parameter", 0}, 
	{"move_left_right_using_parameter", 1, 0.75},
...
object = addStrokeSymbol(nil, {"pnb_stroke_symbols_HUD", "4-impact-point"}, "CenterCenter", {0, 0}, HUD_CCRP_origin.name)
...
-- IR Caged
object = addStrokeSymbol(nil, {"pnb_stroke_symbols_HUD", "aim9lm-caged"}, "CenterCenter", {0, 0}, HUD_INT_origin.name)
...
-- IR Uncaged
object = addStrokeSymbol(nil, {"pnb_stroke_symbols_HUD", "aim9lm-uncaged"}, "CenterCenter", {0, 0}, HUD_INT_origin.name)
...
-- MSL recticle
object = addStrokeSymbol(nil, {"pnb_stroke_symbols_HUD", "msl-recticle"}, "CenterCenter", {0, 0}, HUD_INT_origin.name)
...
-- IR Caged
object = addStrokeSymbol(nil, {"pnb_stroke_symbols_HUD", "aim9lm-caged"}, "CenterCenter", {0, 0}, HUD_DGFT_origin.name)
object.element_params = {"HUD_BRIGHT", "WPN_MSL_CAGED"}
object.controllers = {
	{"opacity_using_parameter", 0}, 
	{"parameter_compare_with_number",1,1},
...
-- IR Uncaged
object = addStrokeSymbol(nil, {"pnb_stroke_symbols_HUD", "aim9lm-uncaged"}, "CenterCenter", {0, -DegToMil(1.2)}, HUD_DGFT_origin.name)
object.element_params = {"HUD_BRIGHT", "WPN_MSL_CAGED", "HUD_IR_MISSILE_TARGET_AZIMUTH", "HUD_IR_MISSILE_TARGET_ELEVATION"}
object.controllers = {
	{"opacity_using_parameter", 0}, 
	{"parameter_compare_with_number",1,0},
...
object = addStrokeSymbol(nil, {"pnb_stroke_symbols_HUD", "4-impact-point"}, "CenterCenter", {0, 0}, HUD_Piper_origin.name)

-- LCOS SSLC SNAP out of screen
object = addStrokeSymbol(nil, {"pnb_stroke_symbols_HUD", "fpm-cross"}, "CenterCenter", {0, 0}, HUD_Piper_origin.name)
object.element_params = {"HUD_BRIGHT", "HUD_PIPER_HIDDEN"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number",1,1}}

-- LCOS SSLC recticle
local HUD_DGFT_LCOS_object = addStrokeSymbol(nil, {"pnb_stroke_symbols_HUD", "gun-recticle"}, "CenterCenter", {0, 0}, HUD_Piper_origin.name)
...
object = addStrokeSymbol("HUD_FPM", {"pnb_stroke_symbols_HUD", "2-flightpath-marker"}, "FromSet", {0, 0}, HUD_FPM_origin.name, {{"HUD_FPM_Flash"}})
...
object = addStrokeSymbol("HUD_FPM_CO", {"pnb_stroke_symbols_HUD", "2-flightpath-marker-co"}, "FromSet", {0, 0}, HUD_FPM_origin.name, {{"HUD_FPM_Flash"}})
...
object = addStrokeSymbol("HUD_ILS_LOC", {"pnb_stroke_symbols_HUD", "ils-loc"}, "FromSet", {0, 0}, "HUD_FPM", {{"HUD_FPM_Flash"}})
...
object = addStrokeSymbol("HUD_ILS_GS", {"pnb_stroke_symbols_HUD", "ils-loc"}, "FromSet", {0, 0}, "HUD_FPM", {{"HUD_FPM_Flash"}})
object.init_rot={-90};
object.element_params = {"NAV_ILS_GS_DEV", "NAV_ILS_GS_VALID", "HUD_BRIGHT", "AVIONICS_ANS_MODE"}
object.controllers = {{"move_left_right_using_parameter", 0, 1}, {"parameter_compare_with_number",1,1}, {"opacity_using_parameter", 2}, {"parameter_compare_with_number",3,AVIONICS_ANS_MODE_IDS.ILS}}

-- FPM cross
object = addStrokeSymbol("HUD_FPM_Cross", {"pnb_stroke_symbols_HUD", "fpm-cross"}, "FromSet", {0, 0}, "HUD_FPM", {{"HUD_FPM_Cross"}})
...
-- AoA bracket
object = addStrokeSymbol("HUD_AoA_bracket", {"pnb_stroke_symbols_HUD", "aoa-bracket"}, "FromSet", {0, 0}, "HUD_FPM", {{"HUD_AoA_bracket"}})
...
-- addStrokeSymbol("HUD_Tadpole", {"pnb_stroke_symbols_HUD", "3-great-steering-circle"}, "FromSet", nil, HUD_FPM_origin.name, {{"HUD_Tadpole_Pos", 50}})	-- 50 milradians for maximum offset
...
addStrokeSymbol(nil, {"pnb_stroke_symbols_HUD", "7-pup"}, "CenterCenter", {0, DegToMil(90)}, PL_origin.name)
addStrokeSymbol(nil, {"pnb_stroke_symbols_HUD", "7-pup"}, "CenterCenter", {0, DegToMil(-90)}, PL_origin.name)
addStrokeSymbol(nil, {"pnb_stroke_symbols_HUD", "fpm-cross"}, "CenterCenter", {0, DegToMil(-90)}, PL_origin.name,nil, 0.5)
...
addStrokeSymbol("HUD_Roll_Indicator_Caret", {"pnb_stroke_symbols_HUD", "11-roll-caret"}, "FromSet", {0, -94}, HUD_RI_origin_rot.name, {{"HUD_RI_Roll", -55}})
...
addStrokeSymbol("HUD_Velocity_box", {"pnb_stroke_symbols_HUD", "9-velocity-box"}, "FromSet", {-9, 0}, HUD_Vel_num_origin.name)
...
object = addStrokeSymbol("HUD_Velocity_Cue", {"pnb_stroke_symbols_HUD", "AA-DLZ-range"}, "RightCenter", {0, 0}, HUD_Velocity_CueOrigin.name)
object.init_rot = {180}
...
addStrokeSymbol("HUD_Altitude_box", {"pnb_stroke_symbols_HUD", "10-altitude-box"}, "FromSet", {-15, 0}, HUD_Alt_num_origin.name)
...
object = addStrokeSymbol("HUD_Alt_Cue", {"pnb_stroke_symbols_HUD", "AA-DLZ-range"}, "RightCenter", {0, 0}, HUD_Alt_Cue_origin.name)
...
object = addStrokeSymbol(nil, {"pnb_stroke_symbols_HUD", "AA-DLZ-range"}, "RightCenter", {0, 0}, HUD_VS_Cue_origin.name)
...
object = addStrokeSymbol("HUD_Hdg_Cue", {"pnb_stroke_symbols_HUD", "AA-DLZ-range"}, "RightCenter", {0, 0}, HUD_Hdg_Cue_origin.name)
object.init_rot = {-90}
...
-- DOI
object = addStrokeSymbol("HUD_Doi", {"pnb_stroke_symbols_HUD", "hud-doi"}, "FromSet", {94, 45})
