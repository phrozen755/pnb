...
-- textures["hud_line_dashed_def"]  = {IND_TEX_PATH .. "pnb_Indication_line_Dashed.dds", materials["HUD_IND_DEF"]}
...
-- -- CMFDs
textures["cmfd_tex_eicas"]        = {IND_TEX_PATH .. "pnb_cmfd.png", materials["CMFD_IND_WHITE"]}
...
-- textures["cmfd_line_dashed_def"] = {IND_TEX_PATH .. "pnb_Indication_line_Dashed.dds", materials["CMFD_IND_DEF"]}
-- textures["cmfd_line_dashed_r"]   = {IND_TEX_PATH .. "pnb_Indication_line_Dashed.dds", materials["CMFD_IND_RED"]}
-- textures["cmfd_line_dashed_w"]   = {IND_TEX_PATH .. "pnb_Indication_line_Dashed.dds", materials["CMFD_IND_WHITE"]}
-- textures["cmfd_line_dashed_y"]   = {IND_TEX_PATH .. "pnb_Indication_line_Dashed.dds", materials["CMFD_IND_YELLOW"]}
...
-- -- HUD
-- fonts["hud_font_def"]   = {fontdescription["pnb_font_hud"], 10, materials["HUD_IND_DEF"]}
-- fonts["hud_font_g"]     = {fontdescription["pnb_font_hud"], 10, materials["HUD_IND_GREEN"]}
-- fonts["hud_font_b"]     = {fontdescription["pnb_font_hud"], 10, materials["HUD_IND_BLUE"]}
-- fonts["hud_font_w"]     = {fontdescription["pnb_font_hud"], 10, materials["HUD_IND_WHITE"]}
-- fonts["hud_font_r"]     = {fontdescription["pnb_font_hud"], 10, materials["HUD_IND_RED"]}
