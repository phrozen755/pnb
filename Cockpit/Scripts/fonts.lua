...
fontdescription["font_CMFD"] = {
    texture     = LockOn_Options.script_path .. "CMFD/Resources/pnb_font_CMFD.dds",
    size        = {10, 10},
...
fontdescription["pnb_font_hud"] = {
	texture    = LockOn_Options.script_path.."Resources/Fonts/pnb_font_HUD.tga",
	size      = {7, 7},
...
fontdescription["font_Arial"] = {
	texture    = LockOn_Options.script_path.."Resources/Fonts/pnb_font_arial.dds",
	size      = {10, 10},
	resolution = {512, 512},
