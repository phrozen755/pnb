...
mount_vfs_texture_path  (current_mod_path.."/Textures/PNB.zip")
...
PNB =  {
	...
	propellorShapeName  = 'pnb_blade.fbx',
	...
	Categories	= {"{78EFB7A2-FD52-4b57-A6A6-3BF0E1D6555F}", "Interceptor",},	
		...
		Pylons =     {
			...
			pylon(6, 0, 1.664, -0.933, 0.715,
				...
				{
				    {CLSID = "{SMOKE-WHITE-PNB}",		    arg_value = 0.2}, -- Smoke pod
				    {CLSID = "{SMOKE-RED-PNB}",		    arg_value = 0.2}, -- Smoke pod
				    {CLSID = "{SMOKE-GREEN-PNB}",		    arg_value = 0.2}, -- Smoke pod
				    {CLSID = "{SMOKE-BLACK-PNB}",		    arg_value = 0.2}, -- Smoke pod
				    {CLSID = "{SMOKE-ORANGE-PNB}",		    arg_value = 0.2}, -- Smoke pod
				    {CLSID = "{SMOKE-YELLOW-PNB}",		    arg_value = 0.2}, -- Smoke pod
				}
			),
	},
